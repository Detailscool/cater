...
+ (void)showCustomerView:(NSString *)title view:(UIView *)view icon:(NSString *)icon {
    [self showCustomerView:title view:view icon:icon interval:1.4];
}
+ (void)showCustomerView:(NSString *)title view:(UIView *)view icon:(NSString *)icon interval:(double)interval {
...
+ (void)showSuccess:(NSString *)title view:(UIView *)view {
   [MBProgressHUD showCustomerView:title view:view icon:@"HUD.bundle/success"];
}
+ (void)showSuccess:(NSString *)title view:(UIView *)view interval:(double)interval{
    [MBProgressHUD showCustomerView:title view:view icon:@"HUD.bundle/success" interval:interval];
}

+ (void)showError:(NSString *)title view:(UIView *)view {
    [MBProgressHUD showCustomerView:title view:view icon:@"HUD.bundle/error"];
}
+ (void)showError:(NSString *)title view:(UIView *)view interval:(double)interval{
    [MBProgressHUD showCustomerView:title view:view icon:@"HUD.bundle/error" interval:interval];
}
